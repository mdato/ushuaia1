...
const ListingDetails = () => {
  return (
    ...
    >
      <VStack spacing={6} alignItems="flex-start">
        <VStack spacing={2} alignItems="flex-start">
          <Heading size="lg">The southernmost city in the world</Heading>
          <HStack spacing={2}>
            <Text color="gray.500">Hosted by</Text>
            <Avatar src="/images/uriah.jpg" size="xs" />
            <Text color="brand.500">Papa Lemmy</Text>
          </HStack>
        </VStack>
        <Divider />
        <VStack alignItems="flex-start" spacing={4}>
          ...
          <Text>
            Our location - behind the Beagle Channel, 15 min drive
            from the city center, will not leave you out from the city's vibrant
            life.
          </Text>
          <Text>
      ...
      >
        <HStack justifyContent="space-between">
          ...
          <Avatar src="/images/uriah.jpg" size="lg">
            <AvatarBadge boxSize="1.38em" bg="green.500" />
          </Avatar>
        </HStack>
        <SimpleGrid
